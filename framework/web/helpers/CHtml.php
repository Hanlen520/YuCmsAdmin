...
class CHtml
{
	 ...
	 */
	public static function label($label,$for,$htmlOptions=array(),$end_separator='：')
	{
		if($for===false)
		...
		if(isset($htmlOptions['required']))
		{
			if($htmlOptions['required'])
			{
				...
				$label=self::$beforeRequiredLabel.self::$afterRequiredLabel.'&nbsp;' .$label;    //edited by qianxfu @ 2013-08-29
			}
			unset($htmlOptions['required']);
		}
		//return self::tag('label',$htmlOptions,$label);
		return self::tag('label',$htmlOptions,$label . $end_separator);    //edited by qianxfu @ 2013-08-29
	}
