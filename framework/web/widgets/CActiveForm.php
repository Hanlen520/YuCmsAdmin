...
class CActiveForm extends CWidget
{
	 ...
	 */
	public static function validate($models, $attributes=null, $loadInput=true, $isReturnjson = true)
	{
		$result=array();
		if(!is_array($models))
			$models=array($models);
	 ...
	 * @return string the JSON representation of the validation error messages.
	 */
	public static function validateTabular($models, $attributes=null, $loadInput=true, $isReturnjson = true)
	{
		$result=array();
		if(!is_array($models))
			$models=array($models);
	...
	/**
	 * 自定义验证
	 * @param object  $models  模型对象
	 * @param string  $fun     函数名称
	 * @param array   $param1     参数1
	 * @param array   $param2     参数2
	 */
	public static function validateCustom($models, $fun, $param1 = null, $param2 = null, $isReturnjson = true)
	{
		if (!$models || !$fun || !$param1) return false;
