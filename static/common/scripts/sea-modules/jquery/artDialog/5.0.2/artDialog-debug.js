 ...
 *  @date: 2013-08-30 
 */
define("jquery/artDialog/5.0.2/artDialog-debug", [ "$-debug" ], function(require, exports, module) {
 ...
 */
        $.tips = $.dialog.tips = function(configs) {
            ...
            var _time = !configs["time"] ? 2e3 : configs["time"] | 0, _width = !configs["width"] ? "auto" : configs["width"], _beforeunload = !configs["beforeunload"] ? function() {
                return;
            } : configs["beforeunload"], _follow = !configs["follow"] ? that.follow : configs["follow"];
            return artDialog({
                id: "Tips",
                title: false,
                content: _tpl,
