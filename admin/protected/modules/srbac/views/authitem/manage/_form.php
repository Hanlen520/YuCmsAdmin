...
<div class="srbacForm">
  ...
  <div class="simple">
    <?php echo SHtml::activeLabelEx($model,'menu'); ?>
    <?php echo SHtml::activeTextArea($model,'menu',array('rows'=>2, 'cols'=>20)); ?>
  </div>
  <div class="simple">
    <?php echo SHtml::activeLabelEx($model,'ismenu'); ?>
    <?php echo SHtml::activeDropDownList($model,'ismenu',AuthItem::$MENUTYPES); ?>
  </div>
