                ...
                <ul class="ul-list" style="padding-top: 0px;margin-left: 10px">
                    <table border="0" width="100%">
                        ...
                        <?php foreach ($actions as $k => $v) :?>
                            <tr height="35">
                                <td><input  type = "checkbox" class="selectCheck" data-tag="1" name = "items[<?php echo $k;?>]" value ="<?php echo $v['itemId'];?>"></td>
...
<script>
    $(function(){
        ...
        $('.btn').click(function(){
            $.ajax({
                type:'POST',
                url: "<?php echo $this->createUrl('delete', array('name' => $data['name']))?>",
                dataType:'json',
